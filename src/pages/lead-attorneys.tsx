  ...
  return (
    <div className="relative w-full md:w-1/2 hover:z-10">
      <div className="overflow-hidden rounded-lg shadow-lg group">
        ...
        />
        <div className="absolute inset-0 flex justify-start items-end p-4 bg-transparent group-hover:bg-black group-hover:bg-opacity-50 transition-all duration-300 rounded-lg">
