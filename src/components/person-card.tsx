export default function PeronCard() {
  return (
    <div>
      <div
        className="u-align-center u-container-list-item u-radius-15 u-repeater-item u-shape-round u-white u-list-item-2"
        data-animation-name=""
      ...
      >
        <div className="u-container-layout u-similar-container u-container-layout-2">
          <div
            className="u-border-4 u-border-palette-2-light-2 u-image u-image-circle u-preserve-proportions u-image-2"
            data-image-width="206"
            data-image-height="206"
          ></div>
          <h4 className="u-text u-text-default u-text-5">May Brown</h4>
          <p className="u-text u-text-body-color u-text-6">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore
          </p>
          <p className="u-text u-text-default u-text-7">Sales Manager</p>
          <div className="u-social-icons u-spacing-10 u-social-icons-2">
            ...
            >
              <span className="u-icon u-social-facebook u-social-icon u-text-black">
                <svg
...
c0-7.4,3.4-18.8,18.8-18.8h13.8v15.4H75.5z"
            ...
            >
              <span className="u-icon u-social-icon u-social-twitter u-text-black">
                <svg
                  className="u-svg-link"
                  preserveAspectRatio="xMidYMin slice"
                  viewBox="0 0 112 112"
	...
	c-1.4,4.3-4.3,7.9-8.1,10.1c3.7-0.4,7.3-1.4,10.6-2.9C98.9,32.3,95.7,35.5,92.2,38.2z"
            ...
            >
              <span className="u-icon u-social-icon u-social-instagram u-text-black">
                <svg
                  className="u-svg-link"
                  preserveAspectRatio="xMidYMin slice"
                  viewBox="0 0 112 112"
